...
BASE_CONFIG = [
  ...
  AmpConfig("Left speaker output volume", 0x18, 0x3D, 0, 0b00011111),
  ...
  AmpConfig("DAI2 attenuation (DV2)", 0xC, 0x31, 0, 0b00001111),
  ...
  AmpConfig("DAI2 EQ attenuation", 0x6, 0x32, 0, 0b00001111),
