...
def create_accel_command(packer, accel, pcm_cancel, standstill_req, lead, acc_type, acc_control):
  # TODO: find the exact canceling bit that does not create a chime
  values = {
    "ACCEL_CMD": acc_control['ACCEL_CMD'],
    "ACCEL_CMD_ALT": acc_control['ACCEL_CMD_ALT'],
    "ACC_TYPE": acc_type,
    "DISTANCE": 0,
    "MINI_CAR": lead,
    "PERMIT_BRAKING": acc_control['PERMIT_BRAKING'],
    "MYSTERY_BIT": acc_control['MYSTERY_BIT'],
