...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam):
    ...
    CAR.PACIFICA_2017_HYBRID, CAR.PACIFICA_2018_HYBRID, CAR.PACIFICA_2019_HYBRID, CAR.PACIFICA_2018, CAR.PACIFICA_2020, CAR.JEEP_CHEROKEE_2019,
    CAR.JEEP_CHEROKEE):
    ...
    if self.CP.carFingerprint in (CAR.RAM_1500, CAR.RAM_2500):
      ...
      self.autoHighBeamBit = cp_cam.vl["DAS_6"][
        'Auto_High_Beam']  # Auto High Beam isn't Located in this message on chrysler or jeep currently located in 729 message
      # ret.cruiseState.speedOffset = ret.cruiseState.speed - ret.vEgo
